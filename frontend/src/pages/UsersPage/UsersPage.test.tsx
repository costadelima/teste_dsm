...
it('fetches and displays users', async () => {
  ...
  const mockUsers = [
    { id: 1, name: 'John Doe', email: 'john.doe@example.com', phone: '123-456-7890', username: 'john.doe'},
    { id: 2, name: 'Jane Smith', email: 'jane.smith@example.com', phone: '987-654-3210', username: 'jane.smith'},
  ];
